...
do
    ...
    python 2d-tracking-yolo-deep-sort.py --video ${VIDEO} --dataset kitti
    python 2d-tracking-yolo-oc-sort.py --video ${VIDEO} --dataset kitti
    python 2d-tracking-yolo-strong-sort.py --video ${VIDEO} --dataset kitti
